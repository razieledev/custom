...
class ir_attachment(osv.Model):
    ...
    def unlink(self, cr, uid, ids, context=None):
        ...
        attach_ids = self.pool.get('ir.attachment').browse(cr, uid, ids)
        if isinstance(attach_ids, (int,long)): attach_ids = [attach_ids]
        for attach in attach_ids:
            if not attach.company_id and attach.company_id.mexican_localization:
